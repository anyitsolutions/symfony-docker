...
use App\Skills\Application\UseCase\Command\SetSkillLevel\SetSkillLevelCommand;
use App\Skills\Application\UseCase\Command\SetSkillLevel\SetSkillLevelCommandResult;
...
use App\Skills\Application\UseCase\Query\GetAllSkillConfirmations\GetAllSkillConfirmationsQuery;
use App\Skills\Application\UseCase\Query\GetAllSkillConfirmations\GetAllSkillConfirmationsQueryResult;
...
readonly class PrivateUseCaseInteractor
{
    ...
    public function confirmSpecialistSkillByTest(ConfirmSpecialistSkillCommand $param): void
    {
    ...
    public function setSkillLevel(
        ...
        string $userId,
        string $level
    ): SetSkillLevelCommandResult {
        $command = new SetSkillLevelCommand($skillId, $userId, $level);

        return $this->commandBus->execute($command);
    }

    public function getAllSkillConfirmations(): GetAllSkillConfirmationsQueryResult
    {
        $query = new GetAllSkillConfirmationsQuery();
